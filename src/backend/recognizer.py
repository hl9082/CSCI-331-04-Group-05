    ...
    def start_recognition(self, on_recognition: Callable[[str], None], stop_event: threading.Event):
        ...
        with self.microphone as source:
            while not stop_event.is_set():
                ...
                try:
                    # Listen with a timeout to allow checking the stop_event
                    ...
                    # This is expected when no speech is detected within the timeout.
                    # Continue to the next iteration to check the stop_event.
                    pass
